...
/**
 * ViewModel описания налога
 */
internal class UidTaxDetailViewModel @AssistedInject constructor(
    ...
    @AssistedFactory
    interface Factory : AssistedSavedStateViewModelFactory<UidTaxDetailViewModel> {
        override fun create(savedStateHandle: SavedStateHandle): UidTaxDetailViewModel
    }
    ...
    override fun onCreate() {
        ...
        if (charge == null) {
            ...
            processNetworkCall(
                ...
                onSuccess = ::showUidTaxDetails,
                onError = ::showError,
            )
        } else {
            showUidTaxDetails(listOf(charge))
        }
    }

    private fun showUidTaxDetails(charges: List<Charge>) {
            ...
            charge?.let {
                addFields(
                    listOf(
                        ...
                        CellFieldValue(
                            title = getString(R.string.ps_uid_auth_need),
                        ...
                        CellFieldValue(
                            ...
                            titleColorRes = R.color.grayscale_carbon,
                        ...
                        TextFieldValue(
                            text = getString(R.string.ps_accrual_amount),
    ...
    private fun onShowRequisites(data: Any?) {
        ...
        data?.let {
            action.value = UidTaxDetailFragmentDirections.uidTaxRequisitesFragmentAction(it as Charge)
        }
    }
    ...
    override fun geSelectCardAction(param: Array<CardDetail>) : NavDirections =
        UidTaxDetailFragmentDirections.selectCardAction(param)
    ...
    private fun paymentAvailable(data: BaseResponse) {
        ...
        action.value = UidTaxDetailFragmentDirections.toAuthDialogAction()
    }
}