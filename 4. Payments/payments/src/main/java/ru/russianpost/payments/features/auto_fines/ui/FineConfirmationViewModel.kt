 ...
 */
internal class FineConfirmationViewModel @Inject constructor(
    ...
    override fun getPaymentCardAction(): NavDirections =
        FineConfirmationFragmentDirections.toPaymentCardAction()

    override fun getAddressDialogAction(): NavDirections =
        FineConfirmationFragmentDirections.addressDialogFragmentAction()
}