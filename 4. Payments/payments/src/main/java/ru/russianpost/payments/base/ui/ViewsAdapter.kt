...
internal fun createViewHolderByType(parent: ViewGroup, viewType: Int): ViewHolder<out ViewDataBinding> {
    val viewHolder = when (viewType) {
        ...
        ViewType.AUTO_FINE.ordinal -> ViewHolder<PsItemAutoFineViewBinding>(R.layout.ps_item_auto_fine_view, parent)
        ViewType.HISTORY.ordinal -> ViewHolder<PsItemAutoFineViewBinding>(R.layout.ps_item_history_view, parent)
